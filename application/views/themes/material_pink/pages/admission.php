...
?>
    ...
    <div class="row">
        <h4 class="pagetitleh2"><?php echo $this->lang->line('Dependants'); ?></h4>
            <?php
    ...
    <div class="row">
        ...
        <div class="col-md-3" hidden>
            <div class="form-group">
                ...
                <input id="guardian_occupation" name="guardian_occupation" placeholder="" type="text" class="form-control"  value="Guardian Occupation" autocomplete="off" />
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-5">
                    <div class="form-group <?php if ($is_captcha) {echo 'btnMD';}?> ">
                       <button type="submit" class="onlineformbtn mt10"><?php echo $this->lang->line('Next_Page'); ?></button>
                    </div>
                </div>
                <div class="col-md-7">
...
document.addEventListener("DOMContentLoaded", function() {
    // Listen for change on guardian_is radios
    const guardianRadios = document.querySelectorAll('input[name="guardian_is"]');
    ...
    guardianRadios.forEach(radio => {
        radio.addEventListener('change', function() {
            if (this.value === "father") {
                ...
                // reset or keep the previous selection if "other"
                guardianRelation.value = "";
            }
        });
    });

    // Optional: set default on page load based on already checked value
    const checkedRadio = document.querySelector('input[name="guardian_is"]:checked');
    if (checkedRadio) {
        if (checkedRadio.value === "father") {
            guardianRelation.value = "Father";
        } else if (checkedRadio.value === "mother") {
            guardianRelation.value = "Mother";
        }
    }
});
